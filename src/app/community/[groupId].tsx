...
import { Screen, Body, H2 as Heading, Eyebrow as Label, Button } from '@/ui';
  ...
  if (meta === null) {
    return (
      <Screen className="items-center justify-center px-8">
        ...
        <Body className="mt-3 text-center text-sm leading-relaxed text-fg-2">
          It may have moved. The rest of the community is still right where you
          left it.
        </Body>
        <Button label="Back to Community" variant="secondary" onPress={goBack} className="mt-8 self-stretch" />
      </Screen>
    );
  }
  ...
  return (
    ...
    <Screen edges={['top']}>
      ...
      >
        ...
        <View
          className="border-t border-stroke bg-bg px-5 pt-3"
