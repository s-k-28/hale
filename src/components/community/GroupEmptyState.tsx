  ...
  return (
    <RiseIn>
      <View className="items-center px-8 py-16">
        <View className="h-14 w-14 items-center justify-center rounded-2xl border border-stroke bg-surface">
          <MessagesSquare color={clean.fg2} size={24} strokeWidth={2} />
        </View>
        <Heading className="mt-5 text-center text-base">{copy.emptyTitle}</Heading>
        <Body className="mt-2 text-center text-sm leading-5 text-fg-2">{copy.emptyBody}</Body>
      </View>
    </RiseIn>
  );
}
